...
export function useVerificaLogin(){
    ...
    //Usando o useEffect, para pegar a lista de usuários, assim que o componente é renderizado na tela
    useEffect(() => {
        // Função para buscar os dados da API
            async function fetchData(){
                try{
                // Váriavel para realizar a requisição
